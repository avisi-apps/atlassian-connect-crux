...
(defn default-interceptors [{:keys [firestore dev? skip-license-check? invalid-license-html]}]
  [;; query-params & form-params
   ...
   (exception/exception-interceptor
     (merge exception/default-handlers {::exception/default (partial ex-handler "Unexpected exception")}))
...
(defn app
  ([router]
   (http/ring-handler
     router
     (ring/routes (ring/redirect-trailing-slash-handler) (ring/create-default-handler))
